...
It is also possible to use the complementiser \textit{da} (\ref{ex:subjclause7}), but in this case the infinitive is highlighted.
...
\glt `Today it is the Furka or the … the \textit{ban} `train', as nowadays it is called in German.' (i.e the Matterhorn-Gotthard-Bahn)\footnotetext{\textit{Ban} is another German word (\textit{Bahn}) for `train'.} (Ruèras, m1, l. 211f.)
\z
